...
import style from "./styles/Acordeon.css"


const QuestionsEspecial = () => {

  return (
    <>{/*Container principal*/}

    <h1 className='classFontAcordeon'>PERGUNTAS FREQUENTES</h1> 

    <div className='containerflexQuestions'>{/*Container geral - acordeon*/}

      <div className='flex_containerQuestions '>{/*Container acordeon a esquerda*/}

      
    <div className='acordeonItem'>
    ...
    <div className='flex_containerQuestions'>{/*Container acordeon a direita*/}
...
export default QuestionsEspecial
